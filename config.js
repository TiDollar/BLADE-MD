...
global.mongodb = process.env.MONGODB_URI || "_mongodb._tcp.cluster0wyozvas.mongodb.net"
...
module.exports = {
  ...
  botname:   process.env.BOT_NAME === undefined ? "NyakazThe bot" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Nyakaz' : process.env.OWNER_NAME,
